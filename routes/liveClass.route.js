...
import { bulkCreateLiveClassesValidation } from "../util/validation.js";
import { bulkCreateLiveClasses } from "../controllers/liveClass.controller.js";

const router = express.Router();

// Dev-only bulk create live classes
router.post(
  "/bulk",
  ensureDevEnvironment,
  bulkCreateLiveClassesValidation,
  bulkCreateLiveClasses
);
...
router.post(
  "/:liveClassId/attendance/:studentId",
  markAttendanceValidation,
  markStudentAttendance
);
